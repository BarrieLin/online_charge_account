...
public class DailyPayChart extends View {
    //原点x坐标
    private int originX;
    //原点y坐标
    private int originY;
...
//    private String legendTitle = "涨停";
    ...
    public DailyPayChart(Context context) {
        this(context, null);
    }

    public DailyPayChart(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DailyPayChart(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
